...
| EV-003/EV-005/EV-005B | EV libraries are finite candidate samples; within-realization replacement is currently a PI decision, not proof that `M` is sufficient. | EV-005B remains proposed until signed; held-out adequacy is deferred to E3.S2a. |
