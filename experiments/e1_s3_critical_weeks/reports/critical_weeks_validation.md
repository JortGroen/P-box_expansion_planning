...
- Standard claim-source manifest: `experiments/e1_s3_critical_weeks/manifest.json`
- Retained/custom evidence: `experiments/e1_s3_critical_weeks/custom_evidence.json`
