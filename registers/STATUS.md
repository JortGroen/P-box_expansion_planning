...
| E2.S3 HP model | C | in-progress | scaffold 4/4; D-003 source-readiness stacked | Concrete When2Heat checksum, shared weather contract path Q-7, and real paired-weather cold-spell acceptance evidence pending | #44; stacked branch `agent-c/E2.S3-d003-source-readiness` |
