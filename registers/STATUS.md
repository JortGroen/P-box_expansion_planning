...
| E2.S3 HP model | C | review | 4/4 | D-003 remains proposed; concrete When2Heat file/checksum not selected; future shared weather/PV layer integration pending | pending |
