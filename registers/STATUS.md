...
|---|---|---|---|---|---|
| E0.S1 Repo & environment | C | review | 4/4 | -- | -- |
| E0.S2 Control registers | C | review | 2/2 | -- | -- |
| E0.S3 Run-manifest utility | C | review | 2/2 | -- | -- |
| E0.S4 Agent working agreement | C | review | 1/1 | -- | -- |
...
| E2.S1 Data acquisition | C | todo | 0/3 | G0 | -- |
...
| E5.S1 Fuzzy number class | B | todo | 0/2 | -- | -- |
