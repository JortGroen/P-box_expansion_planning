...
| E5.S3 Output-domain model-error propagation | B | in-progress | 1/4 + Agent A contract in review | T2-T4: signed A-013, G2 envelope, resolved Q-5, and total-versus-firm capacity decision/provenance before paper use | #36; #13 closed; Agent A contract PR pending |
